...
<body>
    ...
    <script src="{{ asset('backend_admin/assets/js/pages/plugins/lord-icon-2.1.0.js') }}">
    </script>
    ...
    <script src="{{ asset('backend_admin/assets/libs/jsvectormap/maps/world-merc.js') }}">
    </script>
    ...
    <!-- Dashboard init -->
    <script src="{{ asset('backend_admin/assets/js/pages/dashboard-ecommerce.init.js') }}">
    </script>
