            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Disponibilités</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                <li class="breadcrumb-item active">Disponilités</li>
                            </ol>
                        </div>
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name">Disponibilités</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="customer_name">{{ $dispo->dispo}}</td>
                                                <td class="date">{{ $dispo->created_at }}</td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#editModal_{{ $dispo->id }}">Modifier</button>
                                                        </div>
                                                        <form id="form-{{ $dispo->id }}" 
                                                            action="{{ route('delete.dispo', $dispo->id) }}" 
                                                            method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('DELETE')
    
                                                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteModal_{{ $dispo->id }}">Supprimer</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('save.dispo') }}" class="tablelist-form" autocomplete="off" method="POST" 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="customername-field" class="form-control" name="dispo" 
             ...
             @if(!is_null($dispos))
             @foreach($dispos as $dispo)
            <div class="modal fade" id="editModal_{{ $dispo->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-light p-3">
                        ...
                        <form action="{{ route('update.disponibilite', $dispo->id )}}" class="tablelist-form" autocomplete="off" method="POST" 
                            enctype="multipart/form-data">
                            @csrf 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    class="form-control @error('dispo') is-invalid @enderror" value="{{ $dispo->dispo }}" name="dispo" placeholder="Entrez le nom">
                                </div>
                                @error('dispo')
