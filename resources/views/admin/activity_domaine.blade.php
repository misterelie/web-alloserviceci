            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Domaines Activité</h4>
                                    ...
                                    style="width:120% !important">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name">Domaines activité</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="customer_name">{{ $domaine->domaine }}</td>
                                                <td class="date">{{$domaine->created_at}}</td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" 
                                                            data-bs-target="#editModal_{{ $domaine->id }}">Modifier</button>
                                                        </div>
                                                        <form id="form-{{ $domaine->id }}" 
                                                            action="{{ route('delete.domaine', $domaine->id ) }}" 
                                                            method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('DELETE')
    
                                                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" 
                                                            data-bs-target="#deleteModal_{{ $domaine->id }}">Supprimer</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('save_domaine_activity')}}" class="tablelist-form" autocomplete="off" method="POST" 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="customername-field" class="form-control" name="domaine" 
