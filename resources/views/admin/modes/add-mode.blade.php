        ...
        <div class="container-fluid">
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="mode_travail">{{ $mode->mode}}</td>
                                                <td class="customer_name">{{ $mode->created_at}}</td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                       ...
                                                       <form id="form-{{ $mode->id }}" 
                                                        action="{{ route('delete.mode', $mode->id) }}" 
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
             ...
             <!-- end save  ethnie row -->
              ...
              @if(!is_null($modes))
               @foreach($modes as $mode)
               <div class="modal fade" id="editModal_{{ $mode->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-light p-3">
                        ...
                        <form action="{{ route('update.mode', $mode->id) }}" autocomplete="off" method="POST"  enctype="multipart/form-data">
                            @csrf
