    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                                        ...
                                        @if(!is_null($describes))
                                            @foreach($describes as $describe)
                                                <tr>
                                                    ...
                                                    <td>{{ $describe->titre }}</td>
                                                    <td>{!!$describe->description!!}</td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <button class="btn btn-sm btn-success edit-item-btn"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#editModal_{{ $describe->id }}">Modifier</button>
                                                            </div>
                                ...
                                <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('description.regulier')}}"
                ...
                @if(!is_null($describes))
                    @foreach($describes as $describe)
                        <div class="modal fade" id="editModal_{{ $describe->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('describe.update', $describe->id) }}" 
                                        class="tablelist-form" autocomplete="off" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="customername-field" class="form-control"
                                                    value="{{ $describe->titre }}" name="titre"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control ckeditor-classic"
                                                    name="description"
                                                    placeholder="Entrez une description" id="gen-info-description-input" rows="2">{!!$describe->description!!}
                                                 </textarea>
