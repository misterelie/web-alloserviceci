                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Ajouter une ville</button>
                                    ...
                                    <table class="table align-middle" id="customerTable" style="width:100% !important">
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="customer_name">{{ $city->libelle }}</td>
                                                ...
                                                <td class="what">{{ $city->created_at }}</td>
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('admin/villes/cities') }}" class="tablelist-form" autocomplete="off" method="POST" 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    name="libelle" 
                                    placeholder="Saisissez le nom de la ville" required/>
                                </div>
                            </div>
