                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name">Maison</th>
                                        ...
                                        <tbody class="list form-check-all">
                                           ...
                                           <td class="customer_name fw-bold fs-16">{{ $house->libelle }}</td>
                                            <td class="date">{{ date('d.m.Y H:i:s', strtotime($house->created_at ))}}
                                            </td>
                                            ...
                                            <td class="customer_name">
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#editModal_{{ $house->id }}">Editer</button>
                                                        </div>
                                                        <button class="btn btn-sm btn-warning edit-item-btn">
                                                            <a class="text-white" href="#" onclick="if(confirm('Attention ! Vous êtes sur le point de supprimer cet élément ?  Appuyez sur OK pour confirmer.')){document.getElementById('form-{{$house->id}}').submit() }">Supprimer</a>
                                                        </button>
                                                        <form id="form-{{$house->id}}" 
                                                                action="{{ url('delete/house', $house->id) }}" method="post">
                                                                @csrf
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('save/house')}}" class="tablelist-form" autocomplete="off" method="POST" 
             ...
             @if(!is_null($houses))
             @foreach($houses as $house)
            <div class="modal fade" id="editModal_{{ $house->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-light p-3">
                        ...
                        <form action="{{ route('update.house',$house->id)}}" class="tablelist-form" autocomplete="off" method="POST" 
                            enctype="multipart/form-data">
                            @csrf 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    class="form-control" value="{{ $house->libelle }}" name="libelle" placeholder="Entrez le nom">
                                </div>
