...
<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('Vous avez oublié votre mot de passe ? Pas de problème. Indiquez-nous votre adresse électronique et nous vous enverrons un lien de réinitialisation du mot de passe qui vous permettra de choisir un nouveau.') }}
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Réinitialisation du mot de passe</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                                ...
                                <div class="p-2">
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @error('email')
                                                <span class="text-danger">Nous ne trouvons pas d'utilisateur avec cette adresse e-mail.</span>
                                            @enderror
...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-pass-reset-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 11:03:39 GMT -->
</html>