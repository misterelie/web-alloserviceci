...
<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="current_password" name="current_password" type="password" class="mt-1 block form-control w-full" autocomplete="current-password" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button style="background: green;">{{ __('Enregister') }}</x-primary-button>
