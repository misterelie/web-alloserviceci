            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-12 pt-5 mb-5">
                   ...
                   @if(!is_null($assistance->telephone2))
                    ...
                    @if(!is_null($assistance->whatsapp))
                        <div class="d-flex mb-2">
                            <i class="fab fa-whatsapp fw-normal me-2" aria-hidden="true"></i>
                ...
                <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                    ...
                    <div class="link-animated d-flex flex-column justify-content-start">
                        <a class="text-light mb-2" href="{{ url('/')}}"><i class=" bi bi-arrow-right me-2"></i>Accueil</a>
                        <a class="text-light mb-2" href="{{ route('front.presentaion') }}">
                            <i class="bi bi-arrow-right me-2"></i>Présentation</a>
                        <a class="text-light mb-2" href="{{ route('front.nos-prestations') }}"><i class="bi bi-arrow-right  me-2"></i>
                            Nos prestations</a>
                        <a class="text-light mb-2" href="{{ route('ask.prestation') }} "><i class="bi bi-arrow-right me-2"></i>Demande de prestation</a>
                        <a class="text-light mb-2" href="{{ route('ask.prestataire') }}"><i class="bi bi-arrow-right  me-2"></i>Devenir un prestataire</a>
                        <a class="text-light" href="{{ route('front.contact') }}"><i class=" bi bi-arrow-right  me-2"></i>Contact</a>
                        <a class="text-light" href="http://www.vintage.alloservice.ci/"><i class=" bi bi-arrow-right me-2"></i>Consulter vintage.ci</a>
                        <a class="text-light" href="https://technologies.alloservice.ci/"><i class=" bi bi-arrow-right me-2"></i>Consulter As technologies</a>
